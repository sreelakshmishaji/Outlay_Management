			  ...
			  <header id="header" id="home">
		  			...
		  			<div class="container">
				  		<div class="row">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
				  				<a href="tel:8800123654">8800123654 </a>
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.html"><img src="img/images42.jpg" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li class="menu-active"><a href="AdminHome.jsp">Home</a></li>
				          <li class="menu-has-children"><a href="">Address</a>
                                          <ul>
				              ...
				              <li><a href="District.jsp">District</a></li>
                                          ...
                                          <li class="menu-has-children"><a href="">Income</a>
                                          <ul>
				              <li><a href="IncomeType.jsp">Income Type</a></li>
				            </ul>
                                          </li>
                                          <li class="menu-has-children"><a href="">Expence</a>
                                          <ul>
				              <li><a href="ExpenseType.jsp">Expence Type</a></li>
				            </ul>
                                          </li>
				          <li class="menu-has-children"><a href="">Bank Loans</a>
				            <ul>
				              <li><a href="Loan.jsp">Loan</a></li>
				              <li><a href="LoanType.jsp">Loan Type</a></li>
                                              <li><a href="Bank.jsp">Bank</a></li>
				            </ul>
				          </li>	
                                          <li class="menu-has-children"><a href="">Insurances</a>
				            <ul>
				              <li><a href="Insurance.jsp">Insurance</a></li>
				              <li><a href="InsuranceType.jsp">Insurance Type</a></li>
                                              <li><a href="InsuranceCompany.jsp">Insurance Company</a></li>
				            </ul>
				          </li>	
                                           <li class="menu-has-children"><a href="">Settings</a>
                                               <ul>
				          <li><a href="ChangePassword.jsp">Change Password</a></li>
                                          <li><a href="../../Guest/Login_v9/LoginPage.jsp">Logout</a></li>
                                               </ul>
				        </ul>
