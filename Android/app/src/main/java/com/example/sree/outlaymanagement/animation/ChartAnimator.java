package com.example.sree.outlaymanagement.animation;
...
public class ChartAnimator {
   ...
   // @RequiresApi(11)
    ...
    public void animateX(int durationMillis) {
      //  animateX(durationMillis, com.github.mikephil.charting.animation.Easing.Linear);
    }
    ...
    public void animateXY(int durationMillisX, int durationMillisY) {
      //  animateXY(durationMillisX, durationMillisY, com.github.mikephil.charting.animation.Easing.Linear, com.github.mikephil.charting.animation.Easing.Linear);
    }
    ...
    public void animateY(int durationMillis) {
     //   animateY(durationMillis, com.github.mikephil.charting.animation.Easing.Linear);
    }
