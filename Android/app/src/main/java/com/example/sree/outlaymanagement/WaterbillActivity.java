...
public class WaterbillActivity extends AppCompatActivity implements View.OnClickListener {
    Button confirm;
    EditText serviceno;
...
//            Toast.makeText(ElectricitybillActivity.this, s, Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                if(bill.equals("0"))
                {
                    Toast.makeText(WaterbillActivity.this, "Incorrect Service Number", Toast.LENGTH_SHORT).show();
                    serviceno.setText("");
                }
                else
                {
                    Intent i = new Intent(WaterbillActivity.this, PayWaterActivity.class);
